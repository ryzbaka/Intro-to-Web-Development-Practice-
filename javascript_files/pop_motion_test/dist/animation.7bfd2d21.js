...
console.log("this file serves absolutely no purpose at all.");
...
var divStyler = _popmotion.default.styler(ball);

var ballXY = _popmotion.default.value({
  x: 0,
  y: 0
}, divStyler.set);

_popmotion.default.listen(ball, "mousedown touchstart").start(function (e) {
  e.preventDefault();

  _popmotion.default.pointer(ballXY.get()).start(ballXY);
});

_popmotion.default.listen(document, "mouseup").start(function () {
  _popmotion.default.spring({
    from: ballXY.get(),
